...
/* LCD SPI */
#define BSP_PIN_LCD_CS        (GPIO_NUM_7)
#define BSP_PIN_LCD_DC        (GPIO_NUM_6)
#define BSP_PIN_LCD_SCLK      (GPIO_NUM_5)
#define BSP_PIN_LCD_MOSI      (GPIO_NUM_15)
#define BSP_PIN_LCD_RST       (GPIO_NUM_4)
/* TE pin defined but unused (no tearing support yet) */
#define BSP_PIN_LCD_TE        (GPIO_NUM_3)
...
#define BSP_PIN_TOUCH_INT     (GPIO_NUM_16)
